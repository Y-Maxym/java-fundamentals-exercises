...
public class RandomFieldComparator<T> implements Comparator<T> {
    ...
    public String toString() {
        return "Random field comparator of class '%s' is comparing '%s'".formatted(targetType.getSimpleName(), getComparingFieldName());
    }
    ...
    private <U extends Comparable<? super U>> int compareFieldValues(T o1, T o2) {
        ...
        var f1 = (U) fieldToCompare.get(o1);
        var f2 = (U) fieldToCompare.get(o2);
